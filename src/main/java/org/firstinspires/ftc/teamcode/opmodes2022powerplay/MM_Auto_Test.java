...
//        waitForStart();
//
//        robot.lift.collector.changePosition(MM_Collector.CLOSED);
//        sleep(500);
//        robot.lift.slide.waitToReachPosition(MM_Slide.SlidePosition.CONESAVE_POSITION_FRONT);
//        robot.lift.collector.flipConeSaver();
//        robot.drivetrain.microscopicDriveInches(3);
//        robot.drivetrain.strafeInches(23);
//        robot.lift.slide.turner.changeTurnerPosition(0);
